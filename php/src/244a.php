...
<head>
    <meta charset="UTF-8">
    <title>Formulari productes a</title>
</head>
<body>
<?php
    ...
    <form method="post" action="244b.php">
        <?php for ($i = 0; $i < $quantitat; $i++) { ?>
            <div class="form-group row">
                ...
                <div class="col-8">
                    <div class="input-group">
                        <input id="nom<?= $i ?>" name="nom<?= $i ?>" placeholder="Nom del producte" type="text"
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <div class="input-group">
                        <input id="preu<?= $i ?>" name="preu<?= $i ?>" placeholder="Preu del producte" type="text"
                               required="required" class="form-control">
                    </div>
                </div>
            </div>
